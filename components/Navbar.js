      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-5">
            <ul className="flex items-center gap-3">
                ...
                <Image src={"/down.png"} height={20} width={20} alt="icon" className="w-3 h-3"/>
                </li>
                <li className="text-sm font-semibold flex items-center gap-0.5">Solution
                <Image src={"/down.png"} height={20} width={20} alt="icon" className="w-3 h-3"/>
                </li>
                <li className="text-sm font-semibold">Pricing</li>
                <li className="text-sm font-semibold flex items-center gap-0.5">Resources
                <Image src={"/down.png"} height={20} width={20} alt="icon" className="w-3 h-3"/></li>
                <li className="text-sm font-semibold flex items-center gap-0.5">Company
                <Image src={"/down.png"} height={20} width={20} alt="icon" className="w-3 h-3"/></li>
                <li className="text-sm font-semibold flex items-center gap-0.5">Careers
                <Image src={"/down.png"} height={20} width={20} alt="icon" className="w-3 h-3"/></li>
            </ul>
          <ul className="flex items-center gap-3">
            <li className="">
